        ...
        <div class="divide-y divide-gray-50 dark:divide-gray-700">
            ...
            @php
                $statusConfig = [
                    ...
                    'no_data'   => ['icon' => '⏸️', 'label' => 'Kosong','bar' => 'bg-gray-200',    'text' => 'text-gray-400'],
                    'no_budget' => ['icon' => '❓', 'label' => 'No Budget','bar' => 'bg-gray-200', 'text' => 'text-gray-400'],
                ];
                $sc_day = $statusConfig[$day['status']] ?? $statusConfig['no_data'];
            @endphp
            <div class="px-6 py-3 flex items-center gap-4 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors">
