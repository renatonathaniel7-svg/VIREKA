{{-- ============================================================ --}}
{{-- UPDATE: resources/views/income/show.blade.php              --}}
{{-- Tambahkan section ini di bawah detail transaksi utama.     --}}
{{-- Sama persis dengan expenses — hanya beda variable & route. --}}
{{-- ============================================================ --}}

{{--
    Asumsi: variabel $income tersedia di view ini.
    $income->verified_status dapat bernilai: draft|pending|verified|flagged|unverified
--}}
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 mt-6">
    <div class="flex items-center justify-between mb-4">
        ...
        @include('verifications._status_badge', ['status' => $income->verified_status ?? 'draft'])
    </div>

    @php
        $verifiedStatus = $income->verified_status ?? 'draft';

        // Ambil record verifikasi terkait (jika ada)
        $latestVerification = \App\Models\Verification::where('reference_type', 'income')
    ...
    <div class="flex items-start gap-3">
        <div class="flex-1">
            <p class="text-sm text-gray-600">
                Pendapatan ini belum diverifikasi. Upload screenshot mutasi rekening atau
                bukti transfer untuk memasukkannya ke <strong>verified balance</strong>
                dan memperhitungkannya dalam Financial Health Score.
            </p>
            <p class="text-xs text-gray-400 mt-1">
                ℹ Tanpa verifikasi, pendapatan hanya masuk ke shadow balance.
            </p>
        </div>
        <a href="{{ route('verifications.create', ['income', $income->id]) }}"
    ...
    {{-- STATUS: VERIFIED — Pendapatan terverifikasi --}}
    ...
    <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
            <p class="text-sm text-green-700 font-medium">
                Pendapatan berhasil diverifikasi dan sudah masuk ke verified balance.
            </p>
    ...
    {{-- STATUS: UNVERIFIED — Pendapatan tunai / shadow balance --}}
    ...
    <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
            <p class="text-sm text-gray-600">
                <span class="font-medium">Pendapatan tunai.</span>
