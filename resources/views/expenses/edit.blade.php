...
<div class="max-w-xl mx-auto">
    ...
    <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="{{ route('expenses.show', $expense->id) }}" class="hover:text-emerald-600 transition-colors">Detail</a>
    <svg xmlns="http://www.w3.org/2000/svg"
         viewBox="0 0 24 24"
         fill="none"
         stroke="currentColor"
    ...
    <div class="flex items-start gap-3 bg-amber-50 border border-amber-300 rounded-xl px-4 py-3 mb-5">
        ...
        <div>
            <p class="text-sm font-semibold text-amber-800">Transaksi Terverifikasi</p>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6">
        <div class="flex items-center justify-between mb-5">
            <h2 class="text-lg font-bold text-slate-900">Edit Pengeluaran</h2>
        ...
        <form method="POST" action="{{ route('expenses.update', $expense->id) }}" x-data>
            ...
            {{-- Note: verified_status is NOT editable here --}}
